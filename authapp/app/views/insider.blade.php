...
<head>
<meta charset="UTF-8">
<title>Roux Academy Insider</title>
<!--[if lt IE 9]>
...
<h2>Current Show</h2>
<img src="{{ asset('_images/show1.jpg') }}" width="285" height="230" alt="Current show">
...
// BeginOAWidget_Instance_2187524: #mapCanvas
     ...
     function initializeGoogleMap() {
		...
		var latlng = new google.maps.LatLng(40.75399, 
											-73.99891);
		...
		if (true) {
			addMarker(map,40.75399,-73.99891,"Roux Academy");
		}
	  }
